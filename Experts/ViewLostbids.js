...
<View style={styles.header}>
          <Image
            ...
            style={styles.logo}
          />
          <Text style={styles.headerText}>{t("Lost Bids")}</Text>
 ...
 <View style={styles.container}>
      ...
      <View style={styles.row}>
        ...
        <View style={styles.cell}>
          <Text style={{color: 'grey',fontFamily:"Roboto-Light"}}>8</Text>
        </View>
        </View>
        <View style={styles.row}>
        <View style={styles.cell}>
        ...
        <View style={styles.cell}>
          <Text style={{color: 'grey',fontFamily:"Roboto-Light"}}>{t("Closed")}</Text>
        </View>
        </View>
        </View>
...
<Text style={{marginLeft: 165, marginTop: 5, width: 200, fontWeight: '600',fontFamily:"Roboto-Light"}}>{t("Uneditable Section")}</Text>
 ...
 <Text style={{ marginTop: 20, fontWeight: '500', color: 'black', marginLeft: 50,fontFamily:"Roboto-Light" }}>{t("Feedback from the company")}</Text>
              <View style={{ marginTop: 3.5, padding: 6, paddingTop: 8, paddingBottom: 100, backgroundColor: 'none', borderWidth: 2, borderColor: '#CCC', marginLeft: 50, marginRight: 70 }}>
                <Text style={{ color: 'grey', marginTop: 2.5,fontFamily:"Roboto-Light"}}>Hi XYZ, {'\n'}{'\n'}{t("After some careful review of your bid and profile in comparison to others, we regret to inform you that we will not be moving on with you on this journey")}. {'\n'}{'\n'}{t("Thank you for wanting to work with us")}. {'\n'}{'\n'}{t("Kind Regards, MTN Africa")}.</Text>
                </View>

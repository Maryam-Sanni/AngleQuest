...
<BlurView intensity={70} style={{flex: 1}}>
    ...
    <View style={styles.session}>
        <Text style={{ fontWeight: "600", fontSize: 14, color: "#206C00",fontFamily:"Roboto-Light" }}>{t("All upcoming Sessions")}</Text>
        </View>
        </TouchableOpacity>
        <TouchableOpacity>
        <View style={styles.session2}>
        <Text style={{ fontWeight: "600", fontSize: 14, color: "#206C00",fontFamily:"Roboto-Light" }}>{t("Upcoming hub session")}</Text>
        </View>
        </TouchableOpacity>
        <TouchableOpacity>
        <View style={styles.session2}>
        <Text style={{ fontWeight: "600", fontSize: 14, color: "#206C00",fontFamily:"Roboto-Light" }}>{t("Upcoming growth plan")}</Text>
        </View>
        </TouchableOpacity>
        <TouchableOpacity>
        <View style={styles.session2}>
        <Text style={{ fontWeight: "600", fontSize: 14, color: "#206C00",fontFamily:"Roboto-Light"}}>{t("Upcoming reviews")}</Text>
        </View>
        </TouchableOpacity>
        <TouchableOpacity>
        <View style={styles.session2}>
        <Text style={{ fontWeight: "600", fontSize: 14, color: "#206C00",fontFamily:"Roboto-Light" }}>{t("Upcoming advice")}</Text>
      </View>
      </TouchableOpacity>
      </View>
      {/* Session */}

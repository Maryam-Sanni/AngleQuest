...
/>
    ...
    <View style={{ position: 'absolute', right: 30, paddingHorizontal: 8, paddingVertical: 8, borderRadius: 5, backgroundColor: 'coral', width: 100, alignItems: 'center',}}>
     ...
     <View style={styles.BoxesContainer}>
      ...
      <Text style={{ fontSize: 19, fontWeight: 'bold', marginTop: 10, marginLeft: 10, color: '#63EC55',fontFamily:"Roboto-Light"}}>{t("Form a new team to accelerate growth and productivity.")}</Text>
     <Text style={{ fontSize: 15, color: "black", marginTop: 10, marginLeft: 10, marginRight: 150, color: 'white',fontFamily:"Roboto-Light" }}>{t("Create new teams to foster collaboration, enhance communication, leverage diverse skill sets, and collectively achieve the strategic objectives and mission of the company")}</Text>

...
const WincAcademyFooter = () => {
  return (
    <View style={styles.footerContainer}>
      ...
      <Text style={styles.heading}>Still Unsure where to start from or the best fit for you?</Text>
      <Text style={styles.description}>
        We're here to help. Our skill gap analysis offers personalized guidance—simply upload your CV for AI-powered analysis, or answer a few straightforward questions. From there, you can connect with our experts to explore tailored options. It’s the perfect starting point for your learning journey!
      </Text>

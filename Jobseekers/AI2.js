...
import { View, Text, Image, TouchableOpacity, StyleSheet, TextInput, ScrollView, Picker, ImageBackground } from 'react-native';
          ...
          <View style={styles.rows}>
            ...
            <Picker style={styles.picker}>
              ...
              <Picker.Item label={t('Management')} value="Management" />
                  ...
                  <TouchableOpacity style={styles.GO} onPress={gotoresult}>

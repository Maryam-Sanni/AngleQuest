        ...
        <View style={{ flexDirection: 'row', marginTop: 50 }}> 
          ...
          <Text style={{ fontSize: 20, fontWeight: '500' }}>
            ...
            <View style={{flexDirection: 'row', alignSelf: 'center' }}>
              <TouchableOpacity style={[styles.whiteBox, { marginRight: 40, }]} onPress={gotoCV} >
                <Text style={{ fontSize: 18}}>Use CV</Text>  
              <Text style={{fontSize: 12, marginTop: 10, textAlign: 'center'}}>Get a personalized skills gap analysis
                in 2 minutes</Text>
                </TouchableOpacity>

                <TouchableOpacity style={[styles.whiteBox, { marginRight: 20,  }]} onPress={gotoQS}>
                  <Text style={{ fontSize: 18 }}>Use Questionnaire</Text>
              <Text style={{ fontSize: 12, marginTop: 10, textAlign: 'center'}}>Get a personalized skills gap analysis
                in 10 minutes</Text>
                </TouchableOpacity>
            </View>

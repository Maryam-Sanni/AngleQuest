...
<TouchableOpacity style={styles.buttonDue} >
    ...
    <TouchableOpacity style={styles.buttonAcc} >
      <Text style={styles.buttonTextAcc}>{t("Done")} 31/Mar/2024 | {t("Status: Unaccomplished")}</Text>
    </TouchableOpacity>
</View>

<View style={styles.greenBox}> 
<Text style={{ fontSize: 16, color: 'black', fontWeight: 'bold', marginTop: 20, marginLeft: 50,fontFamily:"Roboto-Light" }}>{t("Organization Development Objectives")}</Text>

<View style={{ flexDirection: "row", marginBottom: 10}}>
     <Text style={{ fontSize: 14, color: 'black', marginTop: 3, marginLeft: 50,fontFamily:"Roboto-Light"   }}>{t("Capture what you would like to improve on within the organization")}</Text>

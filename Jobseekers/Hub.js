...
<BlurView intensity={70} style={{flex:1}}>
    <View style={{ flex: 1 }}>
     ...
     <Text style={{ fontSize: 18, fontWeight: 'bold', marginTop: 30, marginLeft: 30}}>About Hubs</Text>
     <Text style={{ fontSize: 14, color: "black", marginTop: 10, marginLeft: 30, marginRight: 200 }}>The goal of a hub is to provide practical knowledge that will enable it's members to grow from one level to the next level in their career.</Text>

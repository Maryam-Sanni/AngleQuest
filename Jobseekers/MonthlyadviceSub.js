            ...
            >
                <View style={{ flex: 1, backgroundColor: "rgba(0, 0, 0, 0.5)", marginTop: 40, alignItems: 'center' }}>
                    <View style={styles.greenBox}>
                        ...
                        <Text style={{ fontSize: 14, color: '#206C00', marginLeft: 65 }}>$80 for Monthly Subscription</Text>
                        ...
                        <Text style={{ fontSize: 14, color: '#206C00', marginLeft: 65, marginTop: 30 }}>Total: $80</Text>

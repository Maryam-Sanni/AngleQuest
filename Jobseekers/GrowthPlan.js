...
<BlurView intensity={70} style={{flex:1}}>
    <View style={{ flex: 1 }}>
          ...
          <View style={styles.header}>
            <TouchableOpacity>
              <View style={styles.item}>
                ...
                <Text style={{color: 'black', fontWeight: '600', marginLeft: 7, fontSize: 16,fontFamily:"Varta-Light" }}>Growth Plan</Text>
              </View>
            </TouchableOpacity>
     ...
     <Text style={{ fontSize: 19, fontWeight: 'bold', marginTop: 30, marginLeft: 30,fontFamily:"Varta-Light"}}>About Growth Plan</Text>
     <Text style={{ fontSize: 15, color: "black", marginTop: 5, marginLeft: 30, marginRight: 200,fontFamily:"Varta-Light" }}>The process begins with selecting an expert to serve as your coach. Next, describe the growth objectives you wish to achieve. Your expert will then review your goals and arrange a meeting to discuss them in detail.</Text>
    ...
    <View style={{ justifyContent: "center", paddingHorizontal: 10, paddingVertical: 10, marginTop: 40, marginLeft: 30, backgroundColor: 'coral', borderRadius: 5, width: 150, alignItems: 'center', alignContent: 'center',}}>
                    <Text style={{ fontSize: 13, color: "white", alignText: 'center', fontWeight: '600',fontFamily:"Varta-Light"}}>Get Started</Text>
                  </View>
     </TouchableOpacity>

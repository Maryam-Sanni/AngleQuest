...
<Text style={{ fontSize: 16, color: 'black', fontWeight: 'bold', marginTop: 20, marginLeft: 50}}>Coach Joop Melcher</Text>


     <Text style={{ fontSize: 14, color: 'black', marginTop: 3, marginLeft: 50, marginBottom: 5    }}>Competence assessment score</Text>

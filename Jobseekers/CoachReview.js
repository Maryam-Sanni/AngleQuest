...
<TouchableOpacity style={styles.buttonDue} >
    ...
    <TouchableOpacity style={styles.buttonAcc} >
      <Text style={styles.buttonTextAcc}>Done 1/Jan/2024 | {t("Status: Unccomplished")}</Text>
    </TouchableOpacity>
    <TouchableOpacity style={styles.buttonAcc} >
...
<Text style={{ fontSize: 16, color: 'black', fontWeight: 'bold', marginTop: 20, marginLeft: 50,fontFamily:"Roboto-Light"}}>{t("Coach")} Joop Melcher</Text>


     <Text style={{ fontSize: 14, color: 'black', marginTop: 3, marginLeft: 50, marginBottom: 5,fontFamily:"Roboto-Light"}}>{t("Competence assessment score")}</Text>
 ...
 <View style={styles.container}>
      ...
      <View style={styles.row}>
        <View style={styles.cell}>
          <Text style={{fontFamily:"Roboto-Light"}}>{t("Feedbacks/remarks")} {t("from")} {t("Coach")}</Text>
        </View>
        <View style={styles.cell}><Text style={{ color: 'grey',fontFamily:"Roboto-Light" }}>{t("Read only field Jobseeker")}</Text>
        </View>
      </View>
    </View>
    </View>

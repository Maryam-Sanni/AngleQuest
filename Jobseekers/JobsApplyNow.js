    ...
    <View style={{ flex: 1  }}>
            ...
            <View style={{ flex: 1 }}>
              <View style={{ paddingHorizontal: 8, paddingTop: 8, backgroundColor: 'white', marginLeft: 210, marginRight: 20, flex: 1 }}>
                <View style={{ flexDirection: 'row', justifyContent: 'space-between', marginHorizontal: 5 }}>
                  <View style={{ flex: 1 }}>
                    <View>
                      <Text style={{ fontSize: 18, color: 'green', fontWeight: '500' }}>Architectural Engineer</Text>
                      <View style={{ flexDirection: 'row', alignItems: 'center', marginBottom: -20, marginLeft: 300 }}>
                        ...
                        />
                        <Text>3 of 5 paid interviews left</Text>
                      </View>
                      <Text style={{ marginTop: 1, fontSize: 12, color: 'black' }}>Chang Xi Architectural Design Firm</Text>
                      <View style={{ flexDirection: 'row', alignItems: 'center', marginTop: 6 }}>
                        ...
                        />
                        <Text style={{ marginTop: 1, fontSize: 12, color: 'black' }}>United Kingdom</Text>
                      </View>
                    </View>
                    <View style={{ marginTop: 20 }}>
                      <Text style={{ fontSize: 14, color: 'black' }}>About Us:</Text>
                      <Text style={{ fontSize: 14, color: 'black' }}>
                        Chang Xi Architectural Design Firm is a leading architectural design firm specializing in residential, commercial, institutional, sustainable design. We are committed to delivering innovative and sustainable architectural solutions that exceed client expectations.
                      </Text>
                      <Text style={{ marginTop: 15, fontSize: 14, color: 'black' }}>Position Overview:</Text>
                      <Text style={{ fontSize: 14, color: 'black' }}>
                        We are seeking a highly skilled and motivated architecture engineer to join our dynamic team. The successful candidate will collaborate with architects, engineers, and clients to develop architectural designs that are both functional and aesthetically pleasing. This is an exciting opportunity to contribute to cutting-edge projects and make a significant impact in the architectural field.
                      </Text>
                      <Text style={{ marginTop: 15, fontSize: 14, color: 'black' }}>Responsibilities:</Text>
                      <Text style={{ fontSize: 14, color: 'black' }}>
                        - Work closely with architects and clients to understand project requirements and objectives.
                        {'\n'}
                        - Develop architectural designs and plans using industry-standard CAD software.
                        {'\n'}
                        - Conduct structural analysis to ensure designs meet safety and building code requirements.
                        {'\n'}
                        - Select appropriate building materials and construction techniques for each project.
                        {'\n'}
                        - Prepare technical drawings, specifications, and cost estimates.
                        {'\n'}
                        - Provide technical guidance and support to project teams throughout the design and construction phases.
                        {'\n'}
                        - Conduct site visits and inspections as needed to monitor progress and resolve technical issues.
                      </Text>
                      <Text style={{ marginTop: 15, fontSize: 14, color: 'black' }}>Qualifications:</Text>
                      <Text style={{ fontSize: 14, color: 'black' }}>
                        - Bachelor's degree in architectural engineering, civil engineering, or a related field.
                        {'\n'}
                        - Professional Engineer (PE) license preferred.
                        {'\n'}
                        - Proficiency in CAD software such as AutoCAD, Revit, or similar programs.
                        {'\n'}
                        - Strong understanding of structural analysis and building design principles.
                        {'\n'}
                      ...
                      <Text style={{ marginTop: 15, fontSize: 14, color: 'black' }}>Benefits:</Text>
                      <Text style={{ fontSize: 14, color: 'black' }}>
        ...
        <View style={{  alignItems: 'flex-end', marginTop: 20, marginLeft: 40   }}>
          <View style={{ backgroundColor: 'white', borderRadius: 8, paddingVertical: 12, paddingHorizontal: 40, shadowColor: '#000', shadowOffset: { width: 0, height: 2 }, shadowOpacity: 0.3, shadowRadius: 3, elevation: 1 }}>
            <TouchableOpacity onPress={() => {/* Handle button press */}}>
              ...
              <Text style={{ fontWeight: 'bold', color: 'white', fontSize: 12, textAlign: 'center' }}>Apply Now</Text>
              </View>
            </TouchableOpacity>
      ...
      <View style={{ flexDirection: "row", justifyContent: "center", marginRight: 2.5}}>
        <Image
          ...
          resizeMode="cover"
        />
        <Text style={{ fontSize: 12, color: 'green' }}>Save</Text>
      </View>
    </View>
            <View style={{ marginTop: 40, marginLeft: -25 }}>
              <Text style={{ color: '#a9a9a9', fontSize: 11 }}>Minimum required score for position: <Text style={{ fontWeight: 'bold',  textDecorationLine: 'underline', fontSize: 11 }}>18</Text></Text>
              <View style={{ flexDirection: 'row', alignItems: 'center', marginTop: 20 }}>
                ...
                />
                <Text style={{ fontSize: 13, color: 'green' }}>$87,000 <Text style={{ fontSize: 13, color: '#a9a9a9' }}>P.A</Text></Text>
              </View>
              <View style={{ flexDirection: 'row', alignItems: 'center', marginTop: 15 }}>
                <Image
                  ...
                  style={{ width: 15, height: 15, marginRight: 5 }}
                />
                <Text style={{ fontSize: 13, color: 'black' }}>Intermediate</Text>
              </View>
              <View style={{ flexDirection: 'row', alignItems: 'center', marginTop: 15 }}>
                <Image
                  ...
                  style={{ width: 15, height: 15, marginRight: 5 }}
                />
                <Text style={{ fontSize: 13, color: 'black' }}>100% On-Site</Text>
              </View>
              <View style={{ flexDirection: 'row', alignItems: 'center', marginTop: 15 }}>
                <Image
                  ...
                  style={{ width: 15, height: 15, marginRight: 5 }}
                />
                 <Text style={{ fontSize: 13, color: 'black' }}>Full-Time</Text>
              </View>
              <View style={{ marginTop: 15 }}>
                 <Text style={{ fontSize: 13, color: 'black' }}>12 Jobs posted</Text>
                <Text style={{ fontSize: 11, color: '#a9a9a9' }}>70% hire rate, 2 open jobs</Text>
                <Text style={{ fontSize: 13, color: 'black', marginTop: 15 }}>Company's Website</Text>
                <Text style={{ fontSize: 11, color: 'green', textDecorationLine: 'underline', marginBottom: 50 }}>changxidesign.com</Text>
              </View>
            </View>
          </View>
        </View>

            ...
            >
                <View style={{ flex: 1, backgroundColor: "rgba(0, 0, 0, 0.5)", marginTop: 40, alignItems: 'center' }}>
                    <View style={styles.greenBox}>
                        ...
                        <Text style={{ fontSize: 14, color: '#206C00', marginLeft: 65,fontFamily:"Roboto-Light" }}>{("$15 for Interview")}</Text>
                        ...
                        <Text style={{ fontSize: 14, color: '#206C00', marginLeft: 65, marginTop: 35,fontFamily:"Roboto-Light" }}>{t("$1250 for Annual Subscription")}</Text>
                        <View style={styles.box}>

...
<Text style={{ fontSize: 16, color: 'black', fontWeight: 'bold', marginTop: 20, marginLeft: 50 }}>Team Development Objectives</Text>

<View style={{ flexDirection: "row", marginBottom: 10}}>
     <Text style={{ fontSize: 14, color: 'black', marginTop: 3, marginLeft: 50   }}>Capture what you would like to improve on or within the team</Text>

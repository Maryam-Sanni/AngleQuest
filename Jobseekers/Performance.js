...
<Text style = {{fontSize: 15, color: 'white',}}>{t("Download PDF")}</Text>
     ...
     <View style={styles.box}>
        ...
        <View style={{flexDirection: 'row' }}>
          <Text style={{fontSize: 14, color: 'black',fontFamily:"Roboto-Light" }}>{t("This is your overall average progress")}</Text>
      ...
      <View style={styles.box}>
        ...
        <View style={{flexDirection: 'row' }}>
          <Text style={{fontSize: 14, color: 'black', width: 100,fontFamily:"Roboto-Light"}}>{t("This is your hub attendance")}</Text>
      ...
      <View style={styles.box}>
        ...
        <View style={{flexDirection: 'row' }}>
          <Text style={{fontSize: 14, color: 'black',fontFamily:"Roboto-Light" }}>{t("This is the growth plan you have completed")}</Text>
          <View style={{ alignItems: 'center', justifyContent: 'center', marginLeft: 10 }}>

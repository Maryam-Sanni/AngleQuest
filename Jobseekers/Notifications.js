      ...
      <Sidebar setShowMenu={handleMenuToggle} /> 
        ...
        <View style={{ flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between' }}>
          ...
          <View style={{ flexDirection: 'row', justifyContent: 'space-between', marginTop: 10 }}>
            <Text style={{ fontSize: 14, fontWeight: '600', color: 'green',fontFamily:"Roboto-Light"  }}>{t("You successfully booked an interview")}</Text>
            <View style={{ width: 6, height: 6, backgroundColor: 'red', borderRadius: 3 }} />
          </View>
          <View style={{ flexDirection: 'row', marginTop: 5 }}>
            <Text style={{ flex: 1, fontSize: 12,fontFamily:"Roboto-Light"  }}>{t("You successfully booked an interview session with John Smith for the following date and time Mon, 12th April 2024 from 09:30pm - 10:30pm. See details of the here...")}</Text>
          ...
          {/* Notification 4 */}
          <View style={{ flexDirection: 'row', justifyContent: 'space-between', marginTop: 20 }}>
            <Text style={{ fontSize: 14, fontWeight: '600', color: 'green',fontFamily:"Roboto-Light"  }}>{t("Feedback shared")}!</Text>
            <View style={{ width: 6, height: 6, backgroundColor: 'red', borderRadius: 3 }} />
          </View>
          <View style={{ flexDirection: 'row', marginTop: 5 }}>
            <Text style={{ flex: 1, fontSize: 12,fontFamily:"Roboto-Light"  }}>{t("Your interview feedback with Mr John Smith has been shared with a Recruiter")}.</Text>
            <Text style={{ fontSize: 10, alignSelf: 'flex-end' }}>3 days ago</Text>
          </View>

          {/* Notification 5 */}
          <View style={{ flexDirection: 'row', justifyContent: 'space-between', marginTop: 20 }}>
            <Text style={{ fontSize: 14, fontWeight: '600', color: 'green',fontFamily:"Roboto-Light"  }}>{t("Congratulations! You’ve been hired")}</Text>
            <View style={{ width: 6, height: 6, backgroundColor: 'red', borderRadius: 3 }} />
          </View>
          <View style={{ flexDirection: 'row', marginTop: 5 }}>
            <Text style={{ flex: 1, fontSize: 12,fontFamily:"Roboto-Light"  }}>{t("Congratulations Moses! You have been selected for the role of an Architectural Engineer at Zulinsky Engineering Agency, Switzerland. Details of your employment have been sent to your mail")}.</Text>
          ...
          {/* Notification 8 */}
          <View style={{ flexDirection: 'row', justifyContent: 'space-between', marginTop: 20 }}>
            <Text style={{ fontSize: 14, fontWeight: '600', color: 'green',fontFamily:"Roboto-Light"  }}>{t("New Job Alert")}!</Text>
            <View style={{ width: 6, height: 6, backgroundColor: 'red', borderRadius: 3 }} />
          </View>
          <View style={{ flexDirection: 'row', marginTop: 5 }}>
            <Text style={{ flex: 1, fontSize: 12,fontFamily:"Roboto-Light"  }}>{t("Exciting opportunity: Architectural Engineer position available at New York Engineering Department in New York, USA. Check out this role now")}.</Text>
            <Text style={{ fontSize: 10, alignSelf: 'flex-end' }}>Tue Nov 13</Text>
          </View>

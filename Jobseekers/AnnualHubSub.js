            ...
            >
                <View style={{ flex: 1, backgroundColor: "rgba(0, 0, 0, 0.5)", marginTop: 40, alignItems: 'center' }}>
                    <View style={styles.greenBox}>
                        ...
                        <Text style={{ fontSize: 14, color: '#206C00', marginLeft: 65,fontFamily:"Roboto-Light" }}>$15 {t("for Interview")}</Text>
                        ...
                        <Text style={{ fontSize: 14, color: '#206C00', marginLeft: 65, marginTop: 35,fontFamily:"Roboto-Light" }}>$1250 {t("for Annual Subscription")}</Text>
                        <View style={styles.box}>
                        ...
                        <Text style={{ fontSize: 14, color: '#206C00', marginLeft: 65, marginTop: 50,fontFamily:"Roboto-Light" }}>{t("Total")}: $855</Text>

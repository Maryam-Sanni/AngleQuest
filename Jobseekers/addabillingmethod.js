        ...
        <View style={{ flex: 1, flexDirection: 'row', backgroundColor: '#ffffff' }}>
          <View style={{ flex: 1, paddingHorizontal: 8, paddingTop: 20 }}>
              ...
              <View style={{ flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between' }}>
                <View style={{ width: '80%' }}>
                  <View style={{ marginBottom: 25 }}>
                    <Text style={{ fontSize: 18, color: '#206C00', fontWeight: 'bold' }}>Add a billing method</Text>
                  </View>
                  <View style={{ marginBottom: 6 }}>
                    <Text style={{ fontSize: 14, fontWeight: '500', color: '#000' }}>Card Number</Text>
                    <View style={{ flexDirection: 'row', alignItems: 'center', paddingHorizontal: 5, paddingVertical: 10, backgroundColor: '#fff', borderRadius: 4, borderWidth: 1, borderColor: '#ccc' }}>
                      ...
                      <TextInput style={{ flex: 1, marginLeft: 5 }} placeholder="1111 2222 3333 4444" />
                    </View>
                  </View>
                  {/* Add other fields similarly */}
                  <View style={{ flexDirection: 'row', marginTop: 20 }}>
                    <View style={{ flex: 1, marginRight: 10 }}>
                      <Text style={{ fontSize: 14, fontWeight: '500', color: '#000' }}>Expiration Month</Text>
                      <TextInput style={{ paddingHorizontal: 10, paddingVertical: 10, backgroundColor: '#fff', borderRadius: 4, borderWidth: 1, borderColor: '#ccc' }} placeholder="MM" />
                    </View>
                    <View style={{ flex: 1 }}>
                      <Text style={{ fontSize: 14, fontWeight: '500', color: '#000' }}>Expiration Year</Text>
                      <TextInput style={{ paddingHorizontal: 10, paddingVertical: 10, backgroundColor: '#fff', borderRadius: 4, borderWidth: 1, borderColor: '#ccc' }} placeholder="YY" />
                    </View>
                  </View>
                  <View style={{ marginTop: 10 }}>
                    <Text style={{ fontSize: 14, fontWeight: '500', color: '#000' }}>Security Code</Text>
                    <TextInput style={{ paddingHorizontal: 10, paddingVertical: 10, backgroundColor: '#fff', borderRadius: 4, borderWidth: 1, borderColor: '#ccc' }} placeholder="3 digits" />
                  </View>
                </View>
              </View>
            </View>
            <View style={{ marginTop: 16 }}>
              <Text style={{ fontSize: 16, fontWeight: 'bold', color: '#206C00', marginTop: 20 }}>Billing Address</Text>
              <View style={{ marginTop: 20 }}>
                <Text style={{ fontSize: 14, fontWeight: '500', color: '#000' }}>Country</Text>
              ...
              <View style={{ marginTop: 20 }}>
                <Text style={{ fontSize: 14, fontWeight: '500', color: '#000' }}>Address Line 1</Text>
                <TextInput style={{ paddingHorizontal: 10, paddingVertical: 10, marginTop: 2.5, width: '80%', backgroundColor: '#fff', borderRadius: 4, borderWidth: 1, borderColor: '#ccc' }} placeholder="Street Address" />
              </View>
              <View style={{ marginTop: 20 }}>
                <Text style={{ fontSize: 14, fontWeight: '500', color: '#000' }}>Address Line 2</Text>
                <TextInput style={{ paddingHorizontal: 10, paddingVertical: 10, width: '80%', marginTop: 2.5, backgroundColor: '#fff', borderRadius: 4, borderWidth: 1, borderColor: '#ccc' }} placeholder="Street Address" />
              </View>
              <View style={{ flexDirection: 'row', marginTop: 20 }}>
                <View style={{ flex: 1, marginRight: 10 }}>
                  <Text style={{ fontSize: 14, fontWeight: '500', color: '#000' }}>City</Text>
                  <TextInput style={{ paddingHorizontal: 10, paddingVertical: 10, width: '60%',  marginTop: 2.5, backgroundColor: '#fff', borderRadius: 4, borderWidth: 1, borderColor: '#ccc' }} placeholder="Enter City" />
                </View>
                <View style={{ flex: 1 }}>
                  <Text style={{ fontSize: 14, fontWeight: '500', color: '#000' }}>Postal Code</Text>
                  <TextInput style={{ paddingHorizontal: 10, paddingVertical: 10, width: '60%', marginTop: 2.5, backgroundColor: '#fff', borderRadius: 4, borderWidth: 1, borderColor: '#ccc' }} placeholder="00000" />
                </View>
              </View>
            </View>
            <TouchableOpacity style={{ alignSelf: 'flex-end', paddingHorizontal: 20, paddingVertical: 10, marginTop: 25, marginRight: 220, backgroundColor: 'coral', borderRadius: 5 }}>
              <Text style={{ fontSize: 14, fontWeight: '500', color: '#fff', textAlign: 'center' }}>Save Changes</Text>
            </TouchableOpacity>
          </View>
            ...
            <View style={{ backgroundColor: 'white', padding: 16, borderRadius: 20, marginTop: 0 }}>
              ...
              <View style={{ marginBottom: 10 }}>
                ...
                <View style={{ flexDirection: 'row', alignItems: 'center' }}>
                  ...
                  <Text style={{ fontSize: 12, color: 'coral', fontWeight: 'bold', marginTop: 15 }}>Billing & Payment</Text>
                </View>
              </View>
            </View>
          </View>

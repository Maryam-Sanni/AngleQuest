...
import OpenModal from '../components/Tour2';
...
const CustomModal = ({ visible, onClose }) => {
  ...
  return (
    <View>
      ...
      >
        <View style={{ flex: 1, justifyContent: 'center', alignItems: 'center', alignSelf: 'flex-start', marginLeft: 210, position: "fixed", top: 220 }}>
          ...
          <View style={{width: 15, height: 15, borderRadius: 10, backgroundColor: '#63EC55', marginRight: 10, marginTop: 5 } }/>
            <Text style={{ fontSize: 18, fontWeight: 'bold', marginBottom: 10 }}>Monitor Growth Plans</Text>
            </View>
            <Text style={{ marginBottom: 20 }}>Track protegees progress, adjust strategies and ensure continuous development towards goals.</Text>

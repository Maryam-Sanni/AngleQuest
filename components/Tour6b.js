  ...
  return (
    <View>
      ...
      >
        ...
        <View style={{ width: 150, height: 30, backgroundColor: '#f7fff4', borderRadius: 10, borderWidth: 2, marginLeft: 25, position: "fixed", top: 530 } }>
        ...
        <View style={{ justifyContent: 'center', alignItems: 'center', alignSelf: 'flex-start', marginLeft: 220, position: "fixed", top: 500 }}>
          ...
          <View style={{width: 15, height: 15, borderRadius: 10, backgroundColor: '#63EC55', marginRight: 10, marginTop: 5 } }/>
            ...
            <Text style={{ marginBottom: 20 }}>We will like to know more about you, thank you for choosing AngleQuest!.</Text>

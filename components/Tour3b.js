...
import OpenModal from '../components/Tour4b';
  ...
  return (
    <View>
      ...
      >
        ...
        <Text style={{ textAlign: 'center', marginLeft: -40, marginTop: 5}}>Hubs</Text>
        </View>
        <View style={{ justifyContent: 'center', alignItems: 'center', alignSelf: 'flex-start', marginLeft: 220, position: "fixed", top: 310 }}>
          ...
          <View style={{width: 15, height: 15, borderRadius: 10, backgroundColor: '#63EC55', marginRight: 10, marginTop: 5 } }/>
            <Text style={{ fontSize: 18, fontWeight: 'bold', marginBottom: 10 }}>Join Hubs </Text>
            <TouchableOpacity onPress={onClose} style={styles.closeButton}>
                <Text style={styles.closeButtonText}> ✕</Text>
              </TouchableOpacity>
            </View>
            <Text style={{ marginBottom: 20 }}>Get extensive training sessions and one-on-one conversations with experts.</Text>

  ...
  return (
    ...
    <View style={styles.pageContainer}>
      ...
      <View style={{flexDirection: 'row', marginBottom: 10, padding: 10, borderBottomColor: '#CCC', borderBottomWidth: 1}}>
        ...
        />
        <Text style={{ fontWeight: 600, color: 'black', marginTop: 10,fontFamily:"Roboto-Light" }}>{t("Training Hub Description")}* ({maxDescriptionLength - descriptionLength} characters remaining)</Text>
        <TextInput

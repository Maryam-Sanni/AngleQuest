...
const DiscussSection = () => {
  const boxData = [
    ...
    },
    {
      ...
      imageUrl:
        "https://cloudcti.nl/sites/default/files/styles/logo/public/externals/8265a353c2552505948a221154fb73ce.png",
    },
    {
      text: "Microsoft Business Central",
      imageUrl:
        "https://play-lh.googleusercontent.com/sCuVNpMVCpDReWX5KK7CSqccS6_S2B4DGgt1hW2xNP724kDdKH_KKGN0PxkFwgKBYa0",
    },
    {
      text: "Microsoft Power Platform",
      imageUrl:
        "https://img.icons8.com/?size=100&id=jXuZmZPUKCPS&format=png&color=000000",
    },
    {
      text: "Scrum",
      imageUrl:
    ...
    },
    {
      text: "Microsoft F&O",
      imageUrl:
        "https://cdn6.aptoide.com/imgs/d/5/6/d56f311244d74f989eb7b7494442d6fd_icon.png",
    },
    {
      ...
      >
          ...
          <View style={styles.greentop}>
            <View style={{ marginLeft: -300 }}>
              <Text style={{ color: "white", fontWeight: "600", fontSize: 20 }}>
                Personalized guidance, tailored training, and on the job support
                – now also available
              </Text>
              <Text style={{ color: "white", marginTop: 10, fontSize: 17 }}>
                Also want an expert to prepare a step-by-step plan to accelerate
                your process? Read more about expert growth plan.
              </Text>
            </View>
          </View>
          {/* Left Card */}
            ...
            <View style={styles.card}>
              <View style={styles.leftSection}>
                ...
                <Text style={styles.header}>
                  Discuss your situation with our expert
                </Text>
                ...
                {isSessionCreated ? (
                  ...
                  <View>
                    <Text style={styles.confirmationText}>
                      Congratulations! Session Created
                    </Text>
                  ...
                  <View>
                    <Text style={styles.subHeader}>
                      Unsure about the technology skill to delve into?
                    </Text>
                    <Text style={styles.listgreen}>
                      ✔{" "}
                      <Text style={styles.listItem}>
                        Discuss with our expert for personalized guidance
                      </Text>
                    </Text>
                    <Text style={styles.listgreen}>
                      ✔{" "}
                      <Text style={styles.listItem}>
                        Quickly gain clarity on the path to follow
                      </Text>
                    </Text>
                    <Text style={styles.listgreen}>
                      ✔{" "}
                      <Text style={styles.listItem}>
                        Feel confident and certain about your next steps
                      </Text>
                    </Text>
                    ...
                    <TouchableOpacity style={{postion: 'relative', zIndex: 100}} onPress={handleOpenPress}>
                      <Text style={styles.footerText}>
                        Need to speak to our expert quickly?{" "}
                        <Text style={styles.linkText}>Schedule urgently</Text>
                      </Text>
                    </TouchableOpacity>
                  </View>
                )}
        ...
        <View style={styles.steppedcontainer}>
            ...
            <View style={styles.row}>
              {boxData.map((box, index) => (
                <Animated.View
                  ...
                  onMouseEnter={
                    Platform.OS === "web" ? () => handleMouseEnter(index) : null
                  }
                  onMouseLeave={
                    Platform.OS === "web" ? () => handleMouseLeave(index) : null
                  }
                >
                  <Image
          ...
          <Text style={styles.subHeading}>
            Subscribe to our{" "}
            <Text style={styles.boldText}>Career Growth & Work Support</Text>{" "}
            program. It’s a robust process that covers everything you would need
            to succeed.
          </Text>
...
const styles = StyleSheet.create({
  ...
  scrollContainer: {
    maxHeight: 200, // Limit height for dropdown
    overflow: "scroll", 
  },
  option: {
    padding: 10,

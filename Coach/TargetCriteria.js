          ...
          <View style={styles.greenBox}>
            <View style={styles.header}>
              <Image
                ...
                style={styles.logo}
              />
              <Text style={styles.headerText}>Specity Target Criteria</Text>
            ...
            <Text style={{  fontSize: 16, marginLeft: 100, marginTop: 10, marginBottom: 30}}>
                  For clarity, monitoring and scoring of the target, specify the measureable criterias...
                </Text>
                <View style={{position: 'absolute', right: 100, marginTop: 120}}>
              <Text style={{color:'#206C00', fontWeight: 'bold', fontSize: 16}}>
                  + New Criteria
                </Text> 
                </View>
